...
class HCDTO : Transform<DataBean> {
    /**
    ...
    override fun toString(): String {
        return "DataBean(yesterday=${yesterday.toString()}, city=$city, ganmao=$ganmao, wendu=$wendu, forecast=${forecast.toString()})"
    }
    override fun transform(): DataBean {
        return DataBean(Gson().toJson(this@HCDTO))
    }
}